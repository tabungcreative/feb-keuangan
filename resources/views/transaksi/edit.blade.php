                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('transaksi.update', $transaksi->kode_transaksi) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_transaksi" class="form-control" value="{{ old('tanggal_transaksi', $transaksi->tanggal) }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="number" name="jumlah_transaksi" class="form-control" min="0" value="{{ old('jumlah_transaksi', $transaksi->debit ?? $transaksi->kredit )}}">
                            </div>
                        </div>
